...
import editor.*;
import editor.herramientas.CircleCreationTool;
import editor.herramientas.RectangleCreationTool;
import editor.herramientas.SelectionTool;
import editor.herramientas.TriangleCreationTool;
...
public class Main 
{
	...
	private void askUser() throws IOException
	{
		...
		if (action.equals("salir")) {
			...
			editor.setHerramientaSeleccionada(new SelectionTool(editor));
		} else if (action.equals("rectangulo")) {
			editor.setHerramientaSeleccionada(new RectangleCreationTool(editor));
		} else if (action.equals("circulo")) {
			editor.setHerramientaSeleccionada(new CircleCreationTool(editor));
		} else if (action.equals("triangulo")) {
			editor.setHerramientaSeleccionada(new TriangleCreationTool(editor));
